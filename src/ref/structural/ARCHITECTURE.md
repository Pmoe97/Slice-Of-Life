...
| `src/ref/wip/scene-reader-ui-plan.md` | Roadmap Plan 2 — `#main-content`'s log becomes a room-scoped scene: composed establishing prose, beats, collapsed history, a moodle strip, sensory icons on the floor plan, attention callouts, and a conversation pane that remembers (**Phases 1–4 built**; Phase 5 outstanding). Created `src/srcfiles/scene.js`. |
