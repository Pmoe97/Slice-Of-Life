...
**A new `src/srcfiles/*.js` needs a line in TWO places**: `index.html`'s script
...
at `srcfiles/` instead of `src/srcfiles/`, and six used a path one level
