...
const OBJECT_DEFS = {
  ...
  // src/src/ref/BrineOS-The-Phone-plan.md, NOT an inventory item: only objects
...
// D17 (npc-avatar-liveliness plan, Q4): curated interaction anchors. A small
// hand-authored table (~10 objects); everything else defaults to
// { anchorMode: 'edge', standInset: 4 }. standInset is the outward offset
// from the object's DRAWN edge an NPC stands at; anchorMode 'center' instead
...
for (const [defId, anchor] of Object.entries({
  ...
  swimming_pool: { standInset: 6 },
  dining_table: { standInset: 6 },
  kitchen_table: { standInset: 6 },
  desk: { standInset: 4 },
  study_desk: { standInset: 4 },
  treadmill: { standInset: 5 },
  shower: { standInset: 5 },
  toilet: { standInset: 4 },
  tv: { standInset: 5 },
  stove: { standInset: 4 },
