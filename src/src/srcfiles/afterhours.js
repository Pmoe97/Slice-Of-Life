...
// route is banned for it and vice versa (see src/src/ref/complete/afterhours-redesign-plan.md).
//
...
//
// Normalized clip shape (data model, src/src/ref/complete/afterhours-redesign-plan.md):
