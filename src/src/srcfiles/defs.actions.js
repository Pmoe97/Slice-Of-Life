...
const ACTION_DEFS = {
  ...
  'intimacy.quickie': {
    ...
    // B6 (2026-08-31, action-photo fix): paired acts now freeze a moment
    // photo too (image.js captureActionMoment) — same hook masturbate uses,
    // with the partner described in the frame via ctx.partner.
    generatesImage: true,
    momentPhrase: 'a quick, breathless intimate moment, close and unselfconscious',
    momentCaption: 'A quick moment together',
  ...
  'intimacy.sex': {
    ...
    generatesImage: true,
    momentPhrase: 'making love, tangled together, the room warm',
    momentCaption: 'Together, intimately',
  ...
  'intimacy.cuddle': {
    ...
    generatesImage: true,
    momentPhrase: 'curled up and holding each other, at ease and close',
    momentCaption: 'Curled up together',
    effects: [
  ...
  'intimacy.share_shower': {
    ...
    emitsSignal: { signal: 'running_water', intensity: SIGNALS_EMIT.shower },
    generatesImage: true,
    momentPhrase: 'sharing a warm shower, taking turns under the water, soapy and wet',
    momentCaption: 'Sharing a warm shower',
