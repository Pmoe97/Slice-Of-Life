...
await check('drives.js/cognition.js introduce no bypass: every Phase 13 partner selection goes through the gate',
      (() => {
        const drivesSrc = fs.readFileSync(path.join(__dirname, '..', '..', 'srcfiles', 'drives.js'), 'utf8');
        ...
        const cogSrc = fs.readFileSync(path.join(__dirname, '..', '..', 'srcfiles', 'cognition.js'), 'utf8');
