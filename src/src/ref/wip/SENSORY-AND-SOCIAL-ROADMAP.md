...
`src/src/ref/patterns/PLAN-ARCHITECTURE.md`; this document does not.
...
| 2 | [`../complete/scene-reader-ui-plan.md`](../complete/scene-reader-ui-plan.md) | **Complete** (2026-08-11) | The interactive-novel main UI, awareness indicators, demoted log, delineated conversation history. Created `src/src/srcfiles/scene.js`; 110 assertions |
