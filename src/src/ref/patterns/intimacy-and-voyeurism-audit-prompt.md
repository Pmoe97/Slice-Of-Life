...
of the 19 shipped phases of `src/src/ref/complete/intimacy-and-voyeurism-overhaul-plan.md`
...
`src/src/ref/complete/intimacy-and-voyeurism-audit-report.md`, then decide with
...
> `src/src/ref/complete/intimacy-and-voyeurism-overhaul-plan.md`. You have no
...
> `src/src/ref/complete/intimacy-and-voyeurism-handoff-prompt.md` (it lists the
...
> - The harnesses were written for `node src/src/dev/verify/run-all.js`, but this
...
>
> Write ONE markdown document, `src/src/ref/complete/intimacy-and-voyeurism-audit-report.md`
...
- The plan lives at `src/src/ref/complete/intimacy-and-voyeurism-overhaul-plan.md`
