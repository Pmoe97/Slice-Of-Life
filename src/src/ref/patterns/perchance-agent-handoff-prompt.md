...
1. `src/src/ref/complete/renovation-occupancy-overhaul-plan.md`
2. `src/src/ref/complete/contractor-tutorial-overhaul-plan.md`
3. `src/src/ref/complete/external-world-npcs-overhaul-plan.md`
...
**One cross-document case needs care.** `src/src/ref/complete/external-world-npcs-overhaul-plan.md`
...
phase, also update `src/src/ref/complete/renovation-occupancy-overhaul-plan.md`'s description
