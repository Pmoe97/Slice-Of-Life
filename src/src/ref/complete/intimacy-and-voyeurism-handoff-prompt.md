...
table in `src/src/ref/complete/intimacy-and-voyeurism-overhaul-plan.md`.
...
5. If this was the last phase, mark the plan's Status header complete and
   move the plan + this prompt to `src/src/ref/complete/` (and update the
   `src/src/ref/README.md` + `src/src/ref/structural/ARCHITECTURE.md` indexes).
