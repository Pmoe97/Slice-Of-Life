...
Companions: `src/src/ref/complete/economy-and-rent-plan.md` (where the money comes from),
`src/src/ref/complete/game-opening-plan.md` (why the place is a wreck),
`src/src/ref/complete/apartment-expansion-plan.md` (the 17-room layout being repaired).
