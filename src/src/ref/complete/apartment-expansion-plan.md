...
the layout and adjacency rationale; see `src/src/ref/structural/ARCHITECTURE.md` for the
as-built architecture.

One open thread: the opening plan (`src/src/ref/complete/game-opening-plan.md`) asks whether
