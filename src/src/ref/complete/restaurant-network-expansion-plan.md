...
`src/src/ref/complete/restaurant-expansion-handoff-prompt.md` (the restaurant-specific
variant of `src/src/ref/patterns/perchance-agent-handoff-prompt.md`). Read its Step 0/Step 1
