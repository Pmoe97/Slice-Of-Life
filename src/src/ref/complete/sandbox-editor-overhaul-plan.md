...
Companions:
- `src/src/ref/complete/seasonal-calendar-and-sandbox-plan.md` (built the sandbox
...
- `src/src/ref/complete/settings-and-pause-overhaul-plan.md` (built the tabbed
...
**Files:**
- `src/src/srcfiles/config.js`: add `SANDBOX_TABS` (Data model above), minus the
...
- `src/src/srcfiles/menu.js`: new `renderSandboxUi()` (mirrors
...
- `src/src/srcfiles/ui.js`: new `handleAction` cases `sandbox.tab` (sets
...
**Files:**
- `src/src/srcfiles/config.js`: fill in `SANDBOX_TABS.house.subtabs`'s two
...
- `src/src/srcfiles/menu.js`: `renderSandboxHousePanel` (`menu.js:465-508`)
  ...
  whole screen.
- `src/src/srcfiles/ui.js`: land D11's two fixes here (duplicate `MENU_ACTIONS`
...
**Files:**
- `src/src/srcfiles/menu.js`: the player-summary block currently inline in
  `renderSandboxScreen` (`menu.js:355-364`) becomes the Player tab's
  content function, unchanged in logic.
- `src/src/srcfiles/config.js`: `SANDBOX_TABS.player`'s content marked as a
...
**Files:**
- `src/src/srcfiles/config.js`: `SANDBOX_DIFFICULTY_PRESETS` (Data model above),
...
- `src/src/srcfiles/menu.js`: the `presetRow` row-kind renderer (button row over
  ...
  parallel dispatcher).
- `src/src/srcfiles/ui.js`: new `handleAction` case `sandbox.difficulty-preset`
...
**Files:**
- `src/src/srcfiles/menu.js`: `renderSandboxRoommateRail` (new — the vertical
...
- `src/src/srcfiles/ui.js`: `handleAction` cases for entering/leaving a
...
**Files:**
- `src/src/srcfiles/menu.js`: a persistent summary strip (roommate count, house
