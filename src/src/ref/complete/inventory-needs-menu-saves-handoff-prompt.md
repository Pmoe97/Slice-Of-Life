...
in `src/src/ref/complete/inventory-needs-menu-saves-plan.md`.
...
**Phase 10 has a required companion read:** `src/src/ref/structural/perchance-menu-conventions.md`
...
- **Hard technical rules every phase must respect:**
  ...
  - **`src/src/ref/structural/perchance-menu-conventions.md` is a reference, not a spec.** It
