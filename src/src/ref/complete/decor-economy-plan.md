...
**Files:**
- `src/src/srcfiles/defs.computer.js`: `APP_DEFS.home`, `DECOR_CATALOG_DEFS`,
  `DECOR_CATALOG_LIST` (mirrors `SHOP_CATALOG_LIST`'s derivation).
- `src/src/srcfiles/computer.js`: generalize `checkoutCart` (computer.js:658)
...
**Files:**
- `src/src/srcfiles/render.computer.js`: the new `home-placement` renderer.
- `src/src/srcfiles/computer.js` or a new file: the placement commit function
