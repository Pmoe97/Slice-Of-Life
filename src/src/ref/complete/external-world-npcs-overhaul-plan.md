...
Companions: `src/src/ref/complete/contractor-tutorial-overhaul-plan.md` (built — the pilot
external NPC this plan generalizes; Del's presence rules are defined here,
everything else about him already shipped),
`src/src/ref/complete/renovation-occupancy-overhaul-plan.md` (built — this plan changes its
`etaDay` math to working days, and puts Del onsite in the room being worked),
`src/src/ref/complete/economy-and-rent-plan.md` (the cost stack these services add to).
...
completion date), `src/src/ref/complete/renovation-occupancy-overhaul-plan.md` (update its
