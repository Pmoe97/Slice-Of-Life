...
`## Status`-equivalent markers in `src/src/ref/complete/restaurant-network-expansion-plan.md`
...
- **Actually run the phase's Verification steps before considering it done**
  ...
  `src/src/ref/structural/ARCHITECTURE.md`'s P2 section for the iframe pattern and the
