...
Companions: `src/src/ref/complete/renovation-occupancy-overhaul-plan.md` (the jobs this
character performs and prices — read that doc first, this one assumes its
data model), `src/src/ref/complete/external-world-npcs-overhaul-plan.md` (the broader
non-resident-NPC framework this character pilots), `src/src/ref/complete/game-opening-plan.md`
...
- The Contractor's IM thread walks the player through: why the place is a
  ...
  this" framing per `src/src/ref/complete/game-opening-plan.md`), how to open RenoFix, what
